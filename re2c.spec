...
Source0  : https://github.com/skvadrik/re2c/releases/download/2.0.2/re2c-2.0.2.tar.xz
...
%prep
%setup -q -n re2c-2.0.2
cd %{_builddir}/re2c-2.0.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1597260367
...
cp %{_builddir}/re2c-2.0.2/LICENSE %{buildroot}/usr/share/package-licenses/re2c/4bc5a5deebfea79e0d2d5b428a6bfd9a6d239959
%make_install
